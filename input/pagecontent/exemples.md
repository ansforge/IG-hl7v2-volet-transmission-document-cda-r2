...
clinicalDocument/relatedDocument@typeCode dans le CDA-R2 (voir [Volet Partage de documents de santé 1.15](https://esante.gouv.fr/sites/default/files/media_entity/documents/ci-sis_service_volet-partage-documents-sante_v1.15.pdf)) permet
de constituer l'association RPLC dans la soumission XDS pour le
remplacement^\[13\]^ [LIEN?]
