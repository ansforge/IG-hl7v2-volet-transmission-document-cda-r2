...
<table class="MsoTable15Grid4Accent1" border="1" cellspacing="0" cellpadding="0" width="649" style="width:487.1pt;border-collapse:collapse;border:none;
 ...
 <tr style="mso-yfti-irow:28">
  ...
  <p class="MsoNormal" align="center" style="margin-bottom:0cm;text-align:center;
  line-height:normal;mso-yfti-cnfc:68"><b><span style="color:black;mso-color-alt:
  windowtext;mso-fareast-language:FR">553</span></b><b><span style="mso-fareast-language:
  FR"><o:p></o:p></span></b></p>
  </td>
  <td width="291" valign="top" style="width:218.05pt;border-top:none;border-left:
  none;border-bottom:solid #9CC2E5 1.0pt;mso-border-bottom-themecolor:accent1;
  ...
  mso-background-themetint:51;padding:0cm 5.4pt 0cm 5.4pt">
  <p class="MsoNormal" style="margin-bottom:0cm;line-height:normal;mso-yfti-cnfc:
  64"><span style="color:black;mso-color-alt:windowtext">La commande a été
  abandonnée car le nom de la boîte aux lettres n'est pas valide.</span><span style="mso-fareast-language:FR"><o:p></o:p></span></p>
  </td>
  <td width="142" valign="top" style="width:106.8pt;border-top:none;border-left:
  none;border-bottom:solid #9CC2E5 1.0pt;mso-border-bottom-themecolor:accent1;
  mso-border-bottom-themetint:153;border-right:solid #9CC2E5 1.0pt;mso-border-right-themecolor:
 ...
 <tr style="mso-yfti-irow:29;mso-yfti-lastrow:yes">
  ...
  153;mso-border-alt:solid #9CC2E5 .5pt;mso-border-themecolor:accent1;
  mso-border-themetint:153;padding:0cm 5.4pt 0cm 5.4pt">
  <p class="MsoNormal" style="margin-bottom:0cm;line-height:normal">Cela signifie
  que l'envoi a échoué. Ce code indique une erreur permanente et le serveur
  n’essaiera pas d’envoyer le message à nouveau.<span style="mso-fareast-language:
  FR"><o:p></o:p></span></p>
  </td>
  <td width="142" valign="top" style="width:106.8pt;border-top:none;border-left:
  none;border-bottom:solid #9CC2E5 1.0pt;mso-border-bottom-themecolor:accent1;
...
<td width="198">
<p><strong>Libell&eacute;</strong></p>
</td>
<td width="378">
...
<td width="378">
<p>Erreur sur un type de donn&eacute;e</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Erreur de cardinalit&eacute; sur un champ du message</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="198">
<p>Autre erreur de syntaxe HL7</p>
</td>
<td width="378">
<p>Autre type d&rsquo;erreur concernant la syntaxe du message HL7</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Type de message non support&eacute;</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Code &eacute;v&egrave;nement non support&eacute;</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Code process non support&eacute;</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Version HL7 non support&eacute;e</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Erreur de niveau applicatif dont le contenu est d&eacute;taill&eacute; dans le champ ERR-5</p>
</td>
</tr>
</tbody>
</table>
...
<td width="198">
<p>Version du document incorrecte lors d&rsquo;une demande de remplacement/suppression</p>
</td>
<td width="378">
<p>Lors d&rsquo;une demande de remplacement ou suppression d&rsquo;un document, la version de document transmise dans le message HL7 ne correspond pas &agrave; la version la plus r&eacute;cente du document existant au niveau de l&rsquo;application r&eacute;ceptrice (consommateur)</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="198">
<p>Auteur non autoris&eacute; &agrave; remplacer ou supprimer un document</p>
</td>
<td width="378">
<p>Lors d&rsquo;une demande de remplacement ou suppression d&rsquo;un document, l&rsquo;acteur qui demande le traitement sur le document doit &ecirc;tre l&rsquo;auteur du document ou un acteur qui appartient &agrave; la m&ecirc;me organisation que l&rsquo;auteur du document original. Dans le cas contraire, le message est rejet&eacute;.</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="378">
<p>Le patient pour lequel le traitement sur le document est demand&eacute; est inconnu de l&rsquo;application r&eacute;ceptrice (consommateur)</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="198">
<p>INS non pr&eacute;sent dans le document</p>
</td>
<td width="378">
<p>Le document CDA contenu dans le message contient une liste d&rsquo;identifiants de patient mais pas l&rsquo;INS. Dans ce cas, la demande de traitement sur le document (int&eacute;gration/remplacement/suppression) ne peut pas &ecirc;tre r&eacute;alis&eacute;e de fa&ccedil;on automatique par le syst&egrave;me consommateur.</p>
</td>
</tr>
<tr>
<td width="75">
...
<td width="198">
<p>L&rsquo;INS transmis ne correspond pas exactement &agrave; celui stock&eacute; dans la base du consommateur</p>
</td>
<td width="378">
<p>L&rsquo;INS du patient est pr&eacute;sent dans le document CDA contenu dans le message HL7 mais les traits ou le matricule ne correspondent pas exactement &agrave; ceux stock&eacute;s dans le syst&egrave;me consommateur. Dans ce cas, la demande de traitement sur le document (int&eacute;gration/remplacement/suppression) ne peut pas &ecirc;tre r&eacute;alis&eacute;e de fa&ccedil;on automatique par le syst&egrave;me consommateur.</p>
</td>
</tr>
</tbody>
</table>
